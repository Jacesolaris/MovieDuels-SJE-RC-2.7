...
using refexport_t = struct
{
	...
	void (*AddPolyToScene)(qhandle_t hShader, int num_verts, const polyVert_t* verts);
	...
	qboolean (*G2API_PauseBoneAnimIndex)(CGhoul2Info* ghl_info, int boneIndex, int AcurrentTime);
	...
	qboolean (*G2API_SetBoneAnimIndex)(CGhoul2Info* ghl_info, int index, int startFrame, int endFrame,
	                                   int flags, float animSpeed, int AcurrentTime, float setFrame, int blendTime);
