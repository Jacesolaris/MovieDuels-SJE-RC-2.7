...
using vehicleInfo_t = struct
{
	...
	int soundTurbo2; //sound to play when turbo/afterburner kicks in
	int soundTurbo3; //sound to play when turbo/afterburner kicks in
	int soundTurbo4; //sound to play when turbo/afterburner kicks in

	int soundBraking; //sound to play when pulling back
	int soundAccelerate; //sound to play when pushing forward
	...
	int soundFlyBy3; //alternate sound to play when they buzz you
	int soundFlyBy4; //alternate sound to play when they buzz you
	int soundFlyBy5; //alternate sound to play when they buzz you
	int soundFlyBy6; //alternate sound to play when they buzz you
	int soundFlyBy7; //alternate sound to play when they buzz you
	int soundFlyBy8; //alternate sound to play when they buzz you
	int soundFlyBy9; //alternate sound to play when they buzz you
	int soundFlyBy10; //alternate sound to play when they buzz you
	int soundFlyBy11; //alternate sound to play when they buzz you
	int soundFlyBy12; //alternate sound to play when they buzz you
	int soundFlyBy13; //alternate sound to play when they buzz you
	int soundFlyBy14; //alternate sound to play when they buzz you
	...
	int soundShift9; //sound to play when decelerating
	int soundShift10; //sound to play when decelerating
...
struct Vehicle_t
{
		...
		ojk::SavedGameHelper& saved_game) const
	{
		...
		saved_game.write<int32_t>(m_vLastFXTime);
		...
		ojk::SavedGameHelper& saved_game)
	{
		...
		saved_game.read<int32_t>(m_vLastFXTime);
