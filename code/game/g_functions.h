...
extern void CG_StasisEffectLong(const centity_t* cent);
...
extern void turret_base_use(const gentity_t* self, gentity_t* other, gentity_t* activator);
...
extern void shield_power_converter_use(gentity_t* self, gentity_t* other, const gentity_t* activator);
...
extern void fx_explosion_trail_use(gentity_t* ent, gentity_t* other, gentity_t* activator);
