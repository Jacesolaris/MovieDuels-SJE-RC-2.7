...
stringID_table_t objectiveTable[] =
{
	...
	ENUM2STRING(EP3_ROC_HANGAR_OBJ1),
	ENUM2STRING(EP3_ROC_HANGAR_OBJ2),
	ENUM2STRING(EP3_ROC_HANGAR_OBJ3),
	ENUM2STRING(EP4_TA_SITH_OBJ1),
	ENUM2STRING(EP6_TGPOC_JEDI_OBJ1),
	ENUM2STRING(EP6_TGPOC_JEDI_OBJ2),
	ENUM2STRING(EP7_ACC_JEDI_OBJ1),
	ENUM2STRING(EP7_ACC_SITH_OBJ1),
	ENUM2STRING(EP8_FT_JEDI_OBJ1),
	ENUM2STRING(EP8_FT_SITH_OBJ1),
