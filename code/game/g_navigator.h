...
namespace NAV
{
	...
	int PathNodesRemaining(const gentity_t* actor);

	const vec3_t& NextPosition(const gentity_t* actor);
	bool NextPosition(const gentity_t* actor, CVec3& Position);
	...
	////////////////////////////////////////////////////////////////////////////////////
	unsigned int ClassifyEntSize(const gentity_t* ent);
	void RegisterDangerSense(const gentity_t* actor, int alertEventIndex);
	void DecayDangerSenses();

	////////////////////////////////////////////////////////////////////////////////////
	// Debugging Information
	////////////////////////////////////////////////////////////////////////////////////
	void ShowDebugInfo(const vec3_t& PlayerPosition, TNodeHandle player_waypoint);
	void ShowStats();
...
namespace STEER
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	void Activate(const gentity_t* actor);
	void DeActivate(gentity_t* actor, usercmd_t* ucmd);
	bool Active(const gentity_t* actor);
	...
	float MatchSpeed(const gentity_t* actor, float speed, float weight = 1.0f);
	...
	////////////////////////////////////////////////////////////////////////////////////
	float Separation(const gentity_t* actor, float Scale = 1.0f);
	float Alignment(gentity_t* actor, float Scale = 1.0f);
	float Cohesion(const gentity_t* actor, float Scale = 1.0f);
	...
	float Wander(const gentity_t* actor);
	float FollowLeader(const gentity_t* actor, gentity_t* leader, float dist);
	...
	// away from them.
	////////////////////////////////////////////////////////////////////////////////////
	float AvoidCollisions(gentity_t* actor, const gentity_t* leader = nullptr);
	gentity_t* SelectLeader(const gentity_t* actor);
	...
	////////////////////////////////////////////////////////////////////////////////////
	void Blocked(const gentity_t* actor, const gentity_t* target);
	void Blocked(const gentity_t* actor, const vec3_t& target);
	bool HasBeenBlockedFor(const gentity_t* actor, int duration);
