...
using setType_t = enum //# setType_e
{
	...
	*/
	...
	SET_MODEL,
	//## %s="NULL" # Set Player's model
	SET_PLAYERSKIN,
	//## %s="model_" # Set Player's skin
	SET_PLAYERSCALE,
	//## %d="100" # Set Player's size
	SET_SOUNDSET,
	//## %s="NULL" # Set Player's soundset
	SET_GENDER,
	//## %s="m/f" # Set Player's gender
	SET_NPCSABER1,
	//## %s="none" # Name of a saber in sabers.cfg to use in first hand.  "none" removes current saber
	SET_NPCSABER2,
	//## %s="none" # Name of a saber in sabers.cfg to use in second hand.  "none" removes current saber
