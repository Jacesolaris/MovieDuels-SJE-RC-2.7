...
void WP_FireSBDPistol(gentity_t* ent, qboolean altFire);
...
void WP_FireJangoDualPistol(gentity_t* ent, qboolean altFire);
void WP_FireJangoFPPistolDuals(gentity_t* ent, qboolean altFire, qboolean second_pistol);
//void WP_FireClonePistollMissile(gentity_t *ent, vec3_t start, vec3_t dir, qboolean altFire);
void WP_FireClonePistol(gentity_t* ent, qboolean altFire);
void WP_FireClonePistolDuals(gentity_t* ent, qboolean altFire, qboolean second_pistol);
