...
using LPLISTENERATTRIBUTES = LISTENERATTRIBUTES FAR*;
...
using LPSOURCEATTRIBUTES = SOURCEATTRIBUTES FAR*;
...
using LPMATERIALATTRIBUTES = MATERIALATTRIBUTES FAR*;
...
using LPDIFFRACTIONBOX = DIFFRACTIONBOX FAR*;
