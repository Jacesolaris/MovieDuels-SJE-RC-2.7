...
static void IN_UseGivenForce(void)
{
	...
	case FP_DEADLYSIGHT:
		...
		break;
	case FP_PROJECTION:
		genCmdNum = GENCMD_FORCE_PROJECTION;
		break;
#endif // !JK2_MODE
...
void CL_InitInput(void)
{
	...
	Cmd_AddCommand("+force_projection", IN_Button15Down);
	Cmd_AddCommand("-force_projection", IN_Button15Up);
	...
	Cmd_AddCommand("+button17", IN_Button17Down);
	Cmd_AddCommand("-button17", IN_Button17Up);
	Cmd_AddCommand("+button18", IN_Button18Down);
	Cmd_AddCommand("-button18", IN_Button18Up);
	Cmd_AddCommand("+button19", IN_Button19Down);
	Cmd_AddCommand("-button19", IN_Button19Up);
	Cmd_AddCommand("+button20", IN_Button20Down);
