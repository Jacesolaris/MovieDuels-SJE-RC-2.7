...
static qboolean CG_CalcFov()
{
	...
	else if (!doing_dash_action && (!cg.zoomMode || cg.zoomMode > 2) && cg.snap->ps.forcePowersActive & 1 <<
		FP_SPEED && player->client->ps.forcePowerDuration[FP_SPEED]) //cg.renderingThirdPerson &&
	{
