...
namespace ragl
{
	...
	public:
		...
		public:
			...
			//
			////////////////////////////////////////////////////////////////////////////////
			void			expand_bounds(const int nodeHandle)
			{
	...
	private:
		...
		public:
			...
			// Constructors
			////////////////////////////////////////////////////////////////////////////////
			search_node(const int Node = -1, const int Parent = -1) :
				mNode(Node),
				mParentVisit(Parent),
				mCostToGoal(-1),
				mCostFromStart(0)
	...
	public:
		...
		public:
			...
			// Constructor
			////////////////////////////////////////////////////////////////////////////////
			search(const int nodeStart = 0, const int nodeEnd = 0) :
				mStart(nodeStart),
				mEnd(nodeEnd)
			{
				clear(true, false);
			...
			////////////////////////////////////////////////////////////////////////////////
			void			clear(const bool clearNodesPtr = true, const bool clearStartAndEnd = true)
			{
				// Reset All Data
				//----------------
				mClosed.clear();
