...
qboolean	G2_SetSurfaceOnOff(CGhoul2Info* ghl_info, surfaceInfo_v& slist, const char* surface_name, int off_flags);
...
qboolean	G2_Set_Bone_Angles(CGhoul2Info* ghl_info, boneInfo_v& blist, const char* bone_name, const float* angles, int flags, Eorientations up, Eorientations left, Eorientations forward, qhandle_t* model_list, int model_index, int blend_time, int currentTime);
qboolean	G2_Remove_Bone(CGhoul2Info* ghl_info, boneInfo_v& blist, const char* bone_name);
qboolean	G2_Set_Bone_Anim(CGhoul2Info* ghl_info, boneInfo_v& blist, const char* bone_name, int start_frame, int end_frame, int flags, float anim_speed, int currentTime, float setFrame, int blend_time);
qboolean	G2_Get_Bone_Anim(CGhoul2Info* ghl_info, boneInfo_v& blist, const char* bone_name, int currentTime, float* current_frame, int* start_frame, int* end_frame, int* flags, float* retAnimSpeed, qhandle_t* model_list, int model_index);
qboolean	G2_Get_Bone_Anim_Range(CGhoul2Info* ghl_info, boneInfo_v& blist, const char* bone_name, int* start_frame, int* end_frame);
qboolean	G2_Pause_Bone_Anim(CGhoul2Info* ghl_info, boneInfo_v& blist, const char* bone_name, int currentTime);
...
qboolean	G2_Set_Bone_Angles_Matrix(const char* fileName, boneInfo_v& blist, const char* bone_name, const mdxaBone_t& matrix, int flags, qhandle_t* model_list, int model_index, int blend_time, int currentTime);
int			G2_Get_Bone_Index(CGhoul2Info* ghoul2, const char* bone_name);
qboolean	G2_Set_Bone_Angles_Index(boneInfo_v& blist, int index, const float* angles, int flags, Eorientations yaw, Eorientations pitch, Eorientations roll, qhandle_t* model_list, int model_index, int blend_time, int currentTime);
qboolean	G2_Set_Bone_Angles_Matrix_Index(boneInfo_v& blist, int index, const mdxaBone_t& matrix, int flags, qhandle_t* model_list, int model_index, int blend_time, int currentTime);
qboolean	G2_Stop_Bone_Anim_Index(boneInfo_v& blist, int index);
qboolean	G2_Stop_Bone_Angles_Index(boneInfo_v& blist, int index);
qboolean	G2_Set_Bone_Anim_Index(boneInfo_v& blist, int index, int start_frame, int end_frame, int flags, float anim_speed, int currentTime, float setFrame, int blend_time, int numFrames);
qboolean	G2_Get_Bone_Anim_Index(boneInfo_v& blist, int index, int currentTime, float* current_frame, int* start_frame, int* end_frame, int* flags, float* retAnimSpeed, qhandle_t* model_list, int model_index);
...
#ifdef _G2_GORE
void		G2_TraceModels(CGhoul2Info_v& ghoul2, vec3_t rayStart, vec3_t rayEnd, CollisionRecord_t* collRecMap, int ent_num, int traceFlags, int use_lod, float fRadius, float ssize, float tsize, float theta, int shader, SSkinGoreData* gore, qboolean skipIfLODNotMatch);
#else
...
qboolean	G2API_SetBoneAnim(CGhoul2Info_v& ghoul2, int model_index, const char* bone_name, int start_frame, int end_frame, int flags, float anim_speed, int currentTime, float setFrame = -1, int blend_time = -1);
qboolean	G2API_GetBoneAnim(CGhoul2Info_v& ghoul2, int model_index, const char* bone_name, int currentTime, float* current_frame, int* start_frame, int* end_frame, int* flags, float* anim_speed, qhandle_t* model_list);
qboolean	G2API_GetAnimRange(CGhoul2Info* ghl_info, const char* bone_name, int* start_frame, int* end_frame);
qboolean	G2API_PauseBoneAnim(CGhoul2Info* ghl_info, const char* bone_name, int currentTime);
...
qboolean G2API_SetBoneAngles(CGhoul2Info_v& ghoul2, int model_index, const char* bone_name, const vec3_t angles, int flags, Eorientations up, Eorientations left, Eorientations forward, qhandle_t* model_list, int blend_time, int currentTime);
...
qboolean	G2API_GetBoltMatrix(CGhoul2Info_v& ghoul2, int model_index, int bolt_index, mdxaBone_t* matrix, const vec3_t angles, const vec3_t position, int frameNum, qhandle_t* model_list, vec3_t scale);
...
qboolean	G2API_SetBoneAnglesMatrix(CGhoul2Info* ghl_info, const char* bone_name, const mdxaBone_t& matrix, int flags, qhandle_t* model_list, int blend_time = 0, int currentTime = 0);
...
qboolean	G2API_SetBoneAnglesIndex(CGhoul2Info* ghl_info, int index, const vec3_t angles, int flags, Eorientations yaw, Eorientations pitch, Eorientations roll, qhandle_t* model_list, int blend_time, int currentTime);
qboolean	G2API_SetBoneAnglesMatrixIndex(CGhoul2Info* ghl_info, int index, const mdxaBone_t& matrix, int flags, qhandle_t* model_list, int blend_time, int currentTime);
qboolean	G2API_DoesBoneExist(CGhoul2Info_v& ghoul2, int model_index, const char* bone_name);
qboolean	G2API_SetBoneAnimIndex(CGhoul2Info* ghl_info, int index, int start_frame, int end_frame, int flags, float anim_speed, int currentTime, float setFrame, int blend_time);
