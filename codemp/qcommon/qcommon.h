...
void MSG_WriteDeltaEntity(msg_t* msg, entityState_s* from, entityState_s* to
	, qboolean force);
...
#else
void MSG_WriteDeltaPlayerstate(msg_t* msg, playerState_s* from, playerState_s* to, qboolean isVehiclePS = qfalse);
#endif
void MSG_ReadDeltaPlayerstate(msg_t* msg, playerState_s* from, playerState_s* to, qboolean isVehiclePS = qfalse);
