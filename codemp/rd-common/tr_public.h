...
typedef struct refexport_s {
	...
	qboolean(*G2API_SetBoneAnglesMatrix)			(CGhoul2Info* ghl_info, const char* bone_name, const mdxaBone_t& matrix, int flags, qhandle_t* model_list, int blend_time, int currentTime);
