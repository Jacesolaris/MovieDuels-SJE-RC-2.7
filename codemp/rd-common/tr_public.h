...
typedef struct refexport_s {
	...
	qboolean(*G2API_SetBoneAnglesMatrix)			(CGhoul2Info* ghl_info, const char* boneName, const mdxaBone_t& matrix, const int flags, qhandle_t* modelList, int blendTime, int currentTime);
