...
static int		c_begins;
static void R_DrawStripElements(int num_indexes, const glIndex_t* indexes, void (APIENTRY* element)(GLint)) {
	glIndex_t last[3];
...
==================
*/
static void R_DrawElements(int num_indexes, const glIndex_t* indexes) {
...
void ForceAlpha(unsigned char* dst_colors, int tr_force_ent_alpha)
{
	dst_colors += 3;
