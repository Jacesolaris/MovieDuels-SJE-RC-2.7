...
void CG_ImpactMark(qhandle_t mark_shader, const vec3_t origin, const vec3_t dir,
	float orientation, float r, float g, float b, float a,
	qboolean alpha_fade, float radius, qboolean temporary) {
	matrix3_t		axis;
	...
	{
		trap->R_AddDecalToScene(mark_shader, origin, dir, orientation, r, g, b, a,
