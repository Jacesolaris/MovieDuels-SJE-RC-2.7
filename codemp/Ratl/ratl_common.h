...
namespace ratl
{
	...
	namespace storage
	{
		...
		struct value_semantics_node
		{
			...
			{
				return *static_cast<NODE*>((unsigned char*)(&v) + size_t(&((TStorage*)0)->nodeData) - size_t(&((TStorage*)0)->value));
			}
			static const NODE& node(const TValue& v)
			{
				return *static_cast<const NODE*>((unsigned char*)(&v) + size_t(&((TStorage*)0)->nodeData) - size_t(&((TStorage*)0)->value));
			}
			static void swap(TStorage* s1, TStorage* s2)
			{
			...
			{
				return
					static_cast<TStorage*>(((unsigned char*)s1) - size_t(&((TStorage*)0)->value)) -
					static_cast<TStorage*>(((unsigned char*)s2) - size_t(&((TStorage*)0)->value));
			}
		};
